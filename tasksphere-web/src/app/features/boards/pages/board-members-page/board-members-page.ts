...
import { BoardMembersComponent } from '@features/boards/components/board-members/board-members';
import { LoadingSpinnerComponent } from '@shared/components/loading-spinner/loading-spinner';
import { Board } from '@core/models';

@Component({
  selector: 'app-board-members-page',
  standalone: true,
  imports: [
    CommonModule,
    LucideAngularModule,
  ...
  template: `
    <div class="min-h-screen bg-background">
      ...
      <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <app-board-members [board]="currentBoard()!"></app-board-members>
        }
      </main>
    </div>
  `,
})
export class BoardMembersPageComponent implements OnInit {
